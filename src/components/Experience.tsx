      ...
      <div className="relative border-l-2 border-gray-200 dark:border-gray-800 ml-4 md:ml-12 pl-8 md:pl-16 space-y-16">
        {EXPERIENCE_TIMELINE.map((item, idx) => {
          ...
          return (
            ...
            >
              {/* Icon Marker */}
              <div className="absolute -left-[49px] md:-left-[81px] top-1.5 flex items-center justify-center p-2.5 rounded-2xl bg-white dark:bg-[#0B0B0F] border-2 border-blue-500 text-blue-600 dark:text-blue-400 z-10 shadow-sm shadow-blue-500/10">
