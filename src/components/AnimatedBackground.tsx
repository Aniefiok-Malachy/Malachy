...
export default function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-50 w-full h-full overflow-hidden bg-white dark:bg-[#0B0B0F] transition-colors duration-500">
      {/* Grid Pattern overlay */}
      <div className="absolute inset-0 grid-bg pointer-events-none" />

      {/* Radial fade to hide edges of grid */}
      <div className="absolute inset-0 bg-radial-gradient from-transparent via-white/50 to-white dark:via-[#0B0B0F]/50 dark:to-[#0B0B0F] pointer-events-none" />
